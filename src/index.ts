...
const init = (context: IExtensionContext) => {
    ...
    const backupMods = (thisGameOnly: boolean = false) => () => {
        ...
        api.selectFile({create: true, title: 'Select file to export to', filters: [{name:"Modlist (*.txt)",extensions:["txt"]},{name:"Modlist (*.json)",extensions:["json"]},{name:"All files (*.*)",extensions:["*"]}]})
            .then(fileName => {
    ...
    const restoreMods = () => {
        ...
        api.selectFile({create: false, title: 'Select your backup file to import', filters: [{name:"Modlist (*.txt)",extensions:["txt"]},{name:"Modlist (*.json)",extensions:["json"]},{name:"All files (*.*)",extensions:["*"]}]})
            .then(fileName => {
